...
const addQuestion = (arr) => arr.map(e => e + '?');
...
const charCode = (arr) => arr.map(e => e.charCodeAt());
...
const evenOdd = (arr) => arr.map(e => e % 2 === 0 ? 'even' : 'odd');
...
const extractAbilities = (arr) => arr.map(e => e.name);
